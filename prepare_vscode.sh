...
setpath "product" "licenseUrl" "https://github.com/GliderOrg/gliderapp/blob/main/LICENSE.txt"
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "Glider - Insiders"
  setpath "product" "nameLong" "Glider - Insiders"
  setpath "product" "applicationName" "glider-insiders"
  setpath "product" "dataFolderName" ".glider-insiders"
  setpath "product" "linuxIconName" "glider-insiders"
  setpath "product" "quality" "insider"
  setpath "product" "urlProtocol" "glider-insiders"
  setpath "product" "serverApplicationName" "glider-server-insiders"
  setpath "product" "serverDataFolderName" ".glider-server-insiders"
  setpath "product" "darwinBundleIdentifier" "ai.glider.GliderInsiders"
  setpath "product" "win32AppUserModelId" "Glider.GliderInsiders"
  setpath "product" "win32DirName" "Glider Insiders"
  setpath "product" "win32MutexName" "gliderinsiders"
  setpath "product" "win32NameVersion" "Glider Insiders"
  setpath "product" "win32RegValueName" "GliderInsiders"
  setpath "product" "win32ShellNameShort" "Glider Insiders"
  ...
  setpath "product" "nameShort" "Glider"
  setpath "product" "nameLong" "Glider"
  setpath "product" "applicationName" "glider"
  setpath "product" "linuxIconName" "glider"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "glider"
  setpath "product" "serverApplicationName" "glider-server"
  setpath "product" "serverDataFolderName" ".glider-server"
  setpath "product" "darwinBundleIdentifier" "com.glider"
  setpath "product" "win32AppUserModelId" "Glider.Glider"
  setpath "product" "win32DirName" "Glider"
  setpath "product" "win32MutexName" "glider"
  setpath "product" "win32NameVersion" "Glider"
  setpath "product" "win32RegValueName" "Glider"
  setpath "product" "win32ShellNameShort" "Glider"
  # Glider - already set in product
