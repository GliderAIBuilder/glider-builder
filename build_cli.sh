...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/GliderOrg/versions/refs/heads/main" # Glider

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/GliderOrg/gliderapp-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/GliderOrg/gliderapp/releases" # Glider
fi
