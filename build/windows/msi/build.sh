...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="Glider - Insiders"
  PRODUCT_CODE="GliderInsiders"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="Glider-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="Glider-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
